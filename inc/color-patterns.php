 ...
 */
function semantify_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'semantify_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.semantify-front-page) .entry-title,
...
.colors-custom .semantify-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.semantify-front-page .panel-content .recent-posts article,
...
.colors-custom.semantify-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'semantify_custom_colors_css', $css, $hue, $saturation );
}
