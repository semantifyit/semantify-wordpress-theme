        ...
        <div class="row white-text">
            ...
            <div class="col s12 l4 m4 cente">
                <div class="preview-box">
                    ...
                    <div class="icons-get">
                        <?php  $val = get_option('footer-section-2-linkedin'); if(trim($val)!="") {?><a href="https://www.linkedin.com/<?php $val;?>"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a><?php  } ?>
                        <?php  $val = get_option('footer-section-2-faceook'); if(trim($val)!="") {?><a href="https://facebook.com/<?php $val;?>"><i class="fa fa-facebook-square" aria-hidden="true"></i></a><?php  } ?>
                        <?php  $val = get_option('footer-section-2-twitter');  if(trim($val)!="") {?><a href="https://twitter.com/<?php $val;?>"><i class="fa fa-twitter-square" aria-hidden="true"></i></a><?php  } ?>
