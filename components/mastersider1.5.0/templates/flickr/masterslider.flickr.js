;(function(){
	...
	var getPhotosetURL = function(key , id , count){
		return 'http://api.flickr.com/services/rest/?method=flickr.photosets.getPhotos&api_key=' + key + '&photoset_id='+ id +'&per_page='+ count +'&format=json&jsoncallback=?';
	};
	
	var getUserPublicURL = function(key , id , count){
		return 'http://api.flickr.com/services/rest/?&method=flickr.people.getPublicPhotos&api_key=' + key + '&user_id='+ id +'&per_page='+ count +'&format=json&jsoncallback=?';
	};
	
	var getImgInfoURL = function(key , id){
		return 'http://api.flickr.com/services/rest/?&method=flickr.photos.getInfo&api_key=' + key + '&photo_id=' + id + '&format=json&jsoncallback=?';
	};
	
	var getIamgeSource = function(fid , server , id , secret , size){
		return 'http://farm' + fid + '.staticflickr.com/'+ server + '/' + id + '_' + secret + size + '.jpg';
	};
